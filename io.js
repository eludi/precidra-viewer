...
// io.js — parse Precidra (.prec) XML into Kernel-loadable data, plus file I/O helpers.
//
// This is a trimmed copy of Precidra's io.js: parsing only (no serialization, no
// DXF/SVG/PDF/PNG export or import, no IndexedDB autosave). Precidra Viewer only
// ever needs to read a .prec file and hand it to Kernel.load().
...
export function loadFile(accept = '.prec,.xml') {
...
/** Apply a loaded document's <grid> settings onto a live Grid/Kernel instance. */
